...
public class GamePanel extends JPanel {
	...
	/** The ui font of type Font */
	public final Font uiFont;

	/** The game of type SoccerGame */
	public SoccerGame game;

	/**
	 * Instantiates a new game panel with Default Color and Font
	 * Set up new Soccer Game from scratch
	 * Repaint the Panel for new Soccer Game
	 */
	public GamePanel() {
		super(null);
	...
	/**
	 * Paint component.
	 * This is responsible to paint every component displayed on the Panel.
	 * That is Paused Text, Gate, Panelty Line, Goal, Timer, Players, Ball, Statistics
	 *
